                          ...
                          if(mysqli_num_rows($query_run) > 0) {
                               ...
                               <form action="code.php" method="POST">
                                   ...
                                   <div class="mb-3">
                                       ...
                                       <input type="text" name="teamname" value="<?=$team['time'];?>" class="form-control">
                                   </div>
                                    <div class="mb-3">
                                       <label>País do time</label>
                                       <input type="text" name="teamcountry" value="<?=$team['pais'];?>" class="form-control">
                                   </div>
                                   <div class="mb-3">
                                       <label>Número de títulos</label>
                                       <input type="text" name="teamtitles" value="<?=$team['numtitulos'];?>" class="form-control">
                                   </div>
                                   <div class="mb-3">
                                       <label>Cor do uniforme</label>
                                       <input type="text" name="teamunicolor" value="<?=$team['coruniforme'];?>" class="form-control">
                                   </div>
                                   <div class="mb-3">
