...
​                           <div class="mb-3">
                           ...
                           <div class="mb-3">
                               <label>País</label>
                               <input type="text" name="teamcountry" class="form-control">
                           </div>
                           <div class="mb-3">
                               <label>Número de títulos</label>
                               <input type="number" name="teamtitles" class="form-control">
                           </div>
                           <div class="mb-3">
                               <label>Cor do uniforme</label>
                               <input type="text" name="teamunicolor" class="form-control">
                           </div>
                           <div class="mb-3">
